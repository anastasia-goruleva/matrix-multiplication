...
public class MatrixMultiplicationDouble {
    ...
    public static void test(int n, int m, int l) {
        ...
        double[][] matrixByStrassenFJ = multiStrassenForkJoin(a, b);
        ...
        double[][] temp = multiStrassen(a_n, b_n, nn);
        double[][] matrixByStrassen = getSubmatrix(temp, n, m);
        end = System.currentTimeMillis();
        ...
        //	TEST 4
        start = System.currentTimeMillis();
        double[][] matrixByUsualTransposed = multiplyTransposed(a, b);
        end = System.currentTimeMillis();
